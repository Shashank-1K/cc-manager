...
node --check "src\cc-manage\dashboard\server.js"
node --check "src\cc-manage\dashboard\data-access.js"
node --check "src\cc-manage\dashboard\providers.js"
$env:CLAUDE_PROFILES_ROOT="$PWD\src\cc-manage"; python tests\test_proxy_conversions.py
$env:CLAUDE_PROFILES_ROOT="$PWD\src\cc-manage"; python tests\test_dashboard.py
```
